    ...
    <ScrollView style={styles.container}>
      ...
      <Card style={styles.cardStyle}>
        ...
        <CardContent>
          <Text style={{ color: 'black' }}>
            Different food have different health impacts to human body, some food needed to be avoided depend on health condition.
          </Text>
        </CardContent>
      ...
      <Card style={styles.cardStyle}>
        ...
        <CardContent>
          <Text style={{ color: 'black' }}>
            Different food have different health impacts to human body, some food needed to be avoided depend on health condition.
            Smoking and drinking are some of the examples of unhealthy activity. Avoid them for a healthy lifestyle.
          </Text>
        </CardContent>
